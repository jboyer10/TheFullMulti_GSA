...
from SA_Attempt3_A2 import SA_FullMulti
...
N_samples = 2048 #180 #2358 #393 for FAST
...
Si_Var = SAP.SA_indices(problem,Si,'Output_Mean',method,'SA_ResultsAA','No_Notes',N_samples)
#Placed at end so that files not unnecessarily generated for failed tests
sys_in = SAP.SAin(problem,param_values,'SA_InputsAA')

Ti = sobol.analyze(problem, E.values)
Ti_Var = SAP.SA_indices(problem,Ti,'Output_Mean',method,'SA_ResultsAA','No_Notes',N_samples)
sys_in = SAP.SAin(problem,param_values,'SA_InputsAA')

Ui = sobol.analyze(problem, F.values)
Ui_Var = SAP.SA_indices(problem,Ui,'Output_Mean',method,'SA_ResultsAA','No_Notes',N_samples)
sys_in = SAP.SAin(problem,param_values,'SA_InputsAA')

Vi = sobol.analyze(problem, G.values)
Vi_Var = SAP.SA_indices(problem,Vi,'Output_Mean',method,'SA_ResultsAA','No_Notes',N_samples)
sys_in = SAP.SAin(problem,param_values,'SA_InputsAA')
