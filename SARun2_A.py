...
from SA_Attempt3_A import SA_FullMulti
...
N_samples = 1024 #180 #2358 #393 for FAST
...
Si_Var = SAP.SA_indices(problem,Si,'Output_Mean',method,'SA_ResultsA','No_Notes',N_samples)
#Placed at end so that files not unnecessarily generated for failed tests
sys_in = SAP.SAin(problem,param_values,'SA_InputsA')

Ti = sobol.analyze(problem, E.values)
Ti_Var = SAP.SA_indices(problem,Ti,'Output_Mean',method,'SA_ResultsA','No_Notes',N_samples)
sys_in = SAP.SAin(problem,param_values,'SA_InputsA')

Ui = sobol.analyze(problem, F.values)
Ui_Var = SAP.SA_indices(problem,Ui,'Output_Mean',method,'SA_ResultsA','No_Notes',N_samples)
sys_in = SAP.SAin(problem,param_values,'SA_InputsA')

Vi = sobol.analyze(problem, G.values)
Vi_Var = SAP.SA_indices(problem,Vi,'Output_Mean',method,'SA_ResultsA','No_Notes',N_samples)
sys_in = SAP.SAin(problem,param_values,'SA_InputsA')
