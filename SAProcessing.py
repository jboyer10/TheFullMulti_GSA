...
def SAin(problem,param_values,csv_name):
    ...
    p = pd.Categorical(['TotDepth', 'widthRS', 'lengthTotal', 'vflow',
                        'density','shape','sizeBin','t_frag_d','t_biof_growth_d'])
                        # 'alpha','t_half_d','t_frag_d'
                        #,'length_a','length_b','length_c','shape', , ,'discharge','density','diameter'])
